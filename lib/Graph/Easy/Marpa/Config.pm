...
sub new
{
	...
	my($path) = Path::Class::file(File::HomeDir -> my_dist_config('Graph-Easy-Marpa'), '.htgraph.easy.marpa.conf');
...
Graph::Easy::Marpa::Config - A Marpa-based parser for Graph::Easy-style Graphviz files
...
The path to the config file is determined by:
	...
	Path::Class::file(File::HomeDir -> my_dist_config('Graph-Easy-Marpa'), '.htgraph.easy.marpa.conf');
...
L<Graph::Easy::Marpa> was written by Ron Savage I<E<lt>ron@savage.net.auE<gt>> in 2012.
